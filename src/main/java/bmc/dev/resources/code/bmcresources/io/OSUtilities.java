...
public class OSUtilities {
     ...
     *
     * @param mojo       AbstractMojo class being passed for its utilities and loaders.
     ...
     */
    public static void makeFilesExecutable(final AbstractMojo mojo, final Entry<Integer, Map<String, String>> computedExecMap) {
